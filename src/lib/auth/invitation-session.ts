const INVITATION_COOKIE = 'topsell_invitation_session'
...
export async function getInvitationSessionFromRequest(request: { cookies: { get: (name: string) => { value: string } | undefined } }) {
