...
function normalizeRegistrationFormPackage(
  ...
  return {
    registrant: {
      ...
      social_media: mergeInput(base.registrant.social_media, value?.registrant?.social_media),
      description: mergeInput(base.registrant.description, value?.registrant?.description),
      photo_urls: mergeInput(base.registrant.photo_urls, value?.registrant?.photo_urls),
      address: mergeInput(base.registrant.address, value?.registrant?.address),
